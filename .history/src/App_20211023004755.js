  ...
  return (
    <div className="App">
      ...
      {isLoading && !tempData.length ? (
        <div className="App-loading">Loading <span className="dot1">.</span><span className="dot1">.</span><span className="dot1">.</span><span className="dot1">.</span><span className="dot1">.</span></div>
      ) : (
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              <th className="App-No">STT</th>
              <th className="App-reason">Lý do từ chối</th>
